...
internal static class Program
{
    internal static void Main(string[] args)
    {
        ...
        // dotnet run -c Release --project bench/Autofac.Extras.DynamicProxy.Benchmarks -- --filter *Benchmarks*
        //
        // Run the benchmark comparing the source code version to a specific package version:
        // dotnet run -c Release --project bench/Autofac.Extras.DynamicProxy.Benchmarks -- --baseline-version 9.0.0 --filter *Benchmarks*
        //
